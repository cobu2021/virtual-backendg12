...
class Pedido(models.Model):
    ...
    propina = models.FloatField()
        ...
        #comprobante = models.OneToOneField(
         #   to=Comprobante, related_name='pedido' ,
          #   on_delete=models.CASCADE, db_column='comprobante_id')
...
class Comprobante(models.Model):
    ...
    tipo = models.CharField(choices=(['BOLETA','BOLETA'], [
                            'FACTURA','FACTURA']), null=False, max_length=16)
...
class DetallePedido(models.Model):
    ...
    stockid = models.ForeignKey(
        to=Stock, related_name='detalle_pedidos', on_delete=models.CASCADE,
        db_column='stock_id')
    pedidoId = models.ForeignKey(
        to=Pedido, related_name='detalle_pedidos', on_delete=models.CASCADE,
        db_column='pedido_id')
