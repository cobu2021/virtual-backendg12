...
#carga todas las variables definidas en el archivo .env para que pueda ser utilizadas
#como variables de entorno sin la necedidad de agregarlas al entorno
load_dotenv()
...
SECRET_KEY = 'django-insecure-+fjza&f9ofek3id76p)!nu8_1ur-e#u85dp%b%-x@+j0(w_(ym'
...
DATABASES = {
    'default': {
        ...
        'NAME': environ.get('DATABASE_NAME'), # nombre de la bd
         ...
         'PASSWORD': environ.get('DATABASE_PASSWORD'), #pasword del servidor
...
#sirve para el uso de plantillas(templates) para que el navegador no me intente traducir
#la pagina desde el ingles o desde otra idioma
LANGUAGE_CODE = 'es'
